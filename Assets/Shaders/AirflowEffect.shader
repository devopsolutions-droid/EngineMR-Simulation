Shader "Custom/AirflowEffect"
{
    Properties
    {
        ...
        // Gradient colours: blue → cyan → white → orange → red
        _Colour1        ("Colour Intake (blue)",   Color) = (0.00, 0.40, 1.00, 1.0)
        _Colour2        ("Colour Compression (cyan)",  Color) = (0.00, 0.90, 1.00, 1.0)
        _Colour3        ("Colour Combustion (white)",  Color) = (1.00, 0.95, 0.80, 1.0)
        _Colour4        ("Colour Turbine (orange)",    Color) = (1.00, 0.50, 0.00, 1.0)
        _Colour5        ("Colour Exhaust (red)",       Color) = (1.00, 0.15, 0.00, 1.0)

        // Gradient keypoint positions along the tube (UV.y = 0 intake → 1 exhaust)
        _Key1           ("Key1 UV.y", Range(0,1)) = 0.00   // blue
        _Key2           ("Key2 UV.y", Range(0,1)) = 0.20   // cyan
        _Key3           ("Key3 UV.y", Range(0,1)) = 0.42   // white
        _Key4           ("Key4 UV.y", Range(0,1)) = 0.70   // orange
        _Key5           ("Key5 UV.y", Range(0,1)) = 1.00   // red
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings i) : SV_Target
            {
                ...
                // Anything past _Progress fades out
