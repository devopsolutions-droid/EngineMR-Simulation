...
namespace UltimateClean
{
    ...
    /// </summary>
    public class CleanButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler
    {
        ...
        {
            // XR ray interactor sends PointerClick instead of PointerDown.
            // This ensures the button fires correctly with VR controllers.
            if (eventData.button != PointerEventData.InputButton.Left)
                return;
