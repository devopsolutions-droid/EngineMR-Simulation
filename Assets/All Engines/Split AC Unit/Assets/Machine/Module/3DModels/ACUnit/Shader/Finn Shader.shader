Shader "Custom/Finn Shader"
{
    Properties
    {
        ...
        _LiquidAlpha ("Liquid Transparency", Range(0,1)) = 1.0 // Transparency control
    ...
    SubShader
    {
        ...
        ZWrite Off                        // Prevent depth write to avoid sorting issues
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                fixed4 liquidColor = _LiquidColor * flowTex;   
                liquidColor.a = _LiquidAlpha;  // Apply transparency
                ...
                return fixed4(finalColor, liquidColor.a); // Use alpha for transparency
            }
            ENDCG
        }
    }
